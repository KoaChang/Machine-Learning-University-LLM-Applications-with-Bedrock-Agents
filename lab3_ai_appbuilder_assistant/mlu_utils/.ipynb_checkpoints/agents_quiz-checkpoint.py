...
lab3_question1 = Quiz(
    question={
        "question": "Which of these steps are NOT part of the Agent workflow by default ",
        "options": [
            "Pre-processing",
            "Orchestration",
...
lab3_question2 = Quiz(
    question={
        "question": "Which of the following Categories of user questions proceed to the Orchestration stage?",
        "options": [
            "Category A, B",
            "All Categories",
            "Category D, E",
