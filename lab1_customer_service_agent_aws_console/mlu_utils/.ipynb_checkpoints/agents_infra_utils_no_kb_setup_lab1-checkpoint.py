...
def setup_agent_infrastructure(schema_filename, kb_db_file_uri, lambda_code_uri):
    ...
    lambda_function = lambda_client.create_function(
        ...
        Handler='customer_service_agent_lambda_function.lambda_handler',
        Environment={
            'Variables': {
    ...
    bedrock_agent_bedrock_allow_policy_statement = {
        ...
        "Statement": [
            {
                "Sid": "AmazonBedrockAgentBedrockFoundationModelPolicyv2",
                "Effect": "Allow",
                "Action": "bedrock:InvokeModel",
                "Resource": [
...
def cleanup_infrastructure_lab1(lambda_name, lambda_role_name, bucket_name, schema_key, agent_bedrock_policy, agent_s3_schema_policy):
