...
lab1_question1 = Quiz(
    question={
        "question": "What is the primary role of an action group in Amazon Bedrock?",
        "options": [
            "To handle natural language processing and understand user inputs.",
            "To define the visual appearance and user interface of the conversational agent.",
            "To specify the tasks or actions that the agent can perform, along with their logic and API interactions.",
            "To manage the deployment and scaling of the conversational agent across different environments.",
        ],
        "correctIndex": 2,
    }
)
...
lab1_question2 = Quiz(
    question={
        "question": "Which of the following statements accurately describes the relationship between an action group's OpenAPI schema and its associated Lambda function?",
        "options": [
            "The OpenAPI schema outlines the API interactions, while the Lambda function handles the business logic for each action.",
            "The OpenAPI schema defines the structure of the Lambda function's code.",
            "The Lambda function is responsible for generating the OpenAPI schema dynamically.",
            "The OpenAPI schema and Lambda function are independent components that do not interact with each other.",
        ],
        "correctIndex": 0,
    }
)
