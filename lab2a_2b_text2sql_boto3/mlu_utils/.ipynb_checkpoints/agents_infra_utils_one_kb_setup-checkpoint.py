...
def setup_agent_infrastructure(schema_filename, kb_db_file_uri, lambda_code_uri):
    ...
    # the .db file is used by lambda to execute queries, it is NOT used in Knowledge base creation
    ...
    lambda_function = lambda_client.create_function(
        ...
        Handler='lambda_function_sql_gen.lambda_handler',
        Environment={
            'Variables': {
