...
lab3_question1 = Quiz(
    question={
        "question": "What is typically used to preserve context in ConversationalRetrievalChain accross conversations",
        "options": [
            "Standalone question",
            "Embedding models",
            "Vector database",
...
lab3_question2 = Quiz(
    question={
        "question": "Which of the following LangChain modules can be used to load data from S3 bucket",
        "options": [
            "S3FileLoader",
            "AWSLoader",
            "URLLoader",
